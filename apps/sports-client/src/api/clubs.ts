...
export const fetchAllClubs = createAsyncThunk('club/fetchAll', async (_) => {
	const response = await clubsApiAxios.get<IClub[]>('');
	return response.data;
});

export const fetchClub = createAsyncThunk('club/fetchOne', async (id: string | undefined) => {
	const response = await clubsApiAxios.get<IClub>(`/${id}`);
	return response.data;
});

export const createClub = createAsyncThunk('club/createClub', async (club: CreateClub) => {
...
export const updateClub = createAsyncThunk('club/updateClub', async (club: IClub) => {
...
export const removeClub = createAsyncThunk('club/remove', async (id: string) => {
