...
router.post('/clubs', validationMiddleware<CreateClubDto>(CreateClubDto), wrapperController(clubsController.create));
router.get('/clubs/:clubId', wrapperController(clubsController.getOne));
router.put('/clubs/:clubId', validationMiddleware<UpdateClubDto>(UpdateClubDto), wrapperController(clubsController.update));
...
router.post('/clubs/:clubId/clients', validationMiddleware<CreateClientDto>(CreateClientDto), wrapperController(clientsControllers.create));
router.get('/clubs/:clubId/clients/:clientId', wrapperController(clientsControllers.getOne));
router.put('/clubs/:clubId/clients/:clientId', validationMiddleware<UpdateClientDto>(UpdateClientDto), wrapperController(clientsControllers.update));
